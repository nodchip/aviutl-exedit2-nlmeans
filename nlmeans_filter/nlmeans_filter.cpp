...
TCHAR	*track_name[] =		{"空間範囲", "時間範囲", "分散", "CPUモード", "先読みフレーム数"};	//	トラックバーの名前
int		track_default[] =	{3, 0, 50, 2, 1};	//	トラックバーの初期値
int		track_s[] =			{1, 0, 0, 0, 1};	//	トラックバーの下限値
int		track_e[] =			{16, 7, 100, 2, 10};	//	トラックバーの上限値
