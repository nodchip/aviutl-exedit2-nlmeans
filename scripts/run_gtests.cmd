...
if exist nlmeans_filter\aviutl2_sdk\filter2.h (
  cl /nologo /utf-8 /EHsc ^
    ...
    nlmeans_filter\tests\GpuCoopExecutionTests.cpp ^
    nlmeans_filter\tests\GpuCoopTaskDispatchTests.cpp ^
    nlmeans_filter\tests\GpuCoopRecoveryPolicyTests.cpp ^
    ...
    nlmeans_filter\tests\MultiGpuComposeTests.cpp ^
    ...
    nlmeans_filter\tests\SelectItemBuilderTests.cpp ^
